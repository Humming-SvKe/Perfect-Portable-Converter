...
## 🎬 **HandBrake Style GUI - READY TO USE!**

### 1️⃣ Stiahni ZIP:
```
https://github.com/Humming-SvKe/Perfect-Portable-Converter/archive/refs/heads/main.zip
```
> **Aktualizované:** Nová verzia s `PerfectConverter.ps1` - HandBrake style GUI!

### 2️⃣ Rozbaľ a spusti START.bat

### 3️⃣ Interface:
- 📁 **Open Source** - Vyber video súbor
- 🎬 **Video Tab** - Codec, quality, resolution
- 🔊 **Audio Tab** - Codec, bitrate
- 📝 **Subtitles** - Import SRT
- 🎨 **Filters** - Watermark editor
